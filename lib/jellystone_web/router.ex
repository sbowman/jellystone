defmodule JellystoneWeb.Router do
  ...
  scope "/", JellystoneWeb do
    ...
    live_session :require_authenticated_user,
      ...
      live(
        "/namespaces/:id/deployments/:deployment_id/edit",
        NamespaceLive.Show,
        :edit_deployment
      )
      ...
      live("/deployments/:id/registrations/new", DeploymentLive.Show, :new_registration)

      live(
        "/deployments/:id/registrations/:registration_id/edit",
        DeploymentLive.Show,
        :edit_registration
      )
      ...
      live("/d/:site_name", SiteLive.Show, :show)
      live("/d/:site_name/:namespace_name", NamespaceLive.Show, :show)
      live("/d/:site_name/:namespace_name/:deployment_name", DeploymentLive.Show, :show)
    end
  end
