defmodule JellystoneWeb.TagLive.Index do
  ...
  def mount(_params, _session, socket) do
    {:ok, stream(socket, :tags, Databases.list_tags())}
  end
  ...
  @impl true
  def handle_info({JellystoneWeb.TagLive.FormComponent, {:saved, tag}}, socket) do
    {:noreply, stream_insert(socket, :tags, tag)}
  end

  @impl true
  def handle_event("delete", %{"id" => id}, socket) do
    tag = Databases.get_tag!(id)
    {:ok, _} = Databases.delete_tag(tag)
