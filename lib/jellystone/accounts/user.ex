defmodule Jellystone.Accounts.User do
  use Ecto.Schema
  ...
  defp maybe_validate_unique_email(changeset, opts) do
    if Keyword.get(opts, :validate_email, true) do
      changeset
      |> unsafe_validate_unique(:email, Jellystone.Repo)
  ...
  """
  def valid_password?(%Jellystone.Accounts.User{hashed_password: hashed_password}, password)
